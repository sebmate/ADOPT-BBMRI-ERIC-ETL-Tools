...
public class MDRPipeConfiguration {
	...
	private static String mappingsFolder;
	...
	private static void setConfigurationsFromXml() {
		...
		MDRPipeConfiguration.setMappingFileName(MDRPipeConfiguration.getXmlConfigurations().getString(basePath + "/fileStructure/mappingFileName"));
		...
		MDRPipeConfiguration.setMappingsFolder(MDRPipeConfiguration.getXmlConfigurations().getString(basePath + "/folderStructure/mappingsFolder"));
		...
		/* Store */
		MDRPipeConfiguration.setStoreUrl(MDRPipeConfiguration.getXmlConfigurations().getString(basePath + "/store/url"));
	...
	public static void setMappingFileName(String mappingFileName) {
		MDRPipeConfiguration.mappingFileName = mappingFileName;
	}
	...
	public static void setMappingsFolder(String mappingsFolder) {
		MDRPipeConfiguration.mappingsFolder = mappingsFolder;
	}
	...
	public static void setStoreUrl(String storeUrl) {
		MDRPipeConfiguration.storeUrl = storeUrl;
	}
